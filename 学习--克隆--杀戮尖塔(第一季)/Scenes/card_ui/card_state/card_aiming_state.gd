...
const MOUSE_Y_SNAPBACK_THRSHOLD := 138
...
func enter() -> void:
	...
	card_ui.animate_to_position(card_ui.parent.position + offset, 0.2)
...
func on_input(event:InputEvent) -> void:
	...
	var mouse_at_bottom := card_ui.get_global_mouse_position().y > MOUSE_Y_SNAPBACK_THRSHOLD
